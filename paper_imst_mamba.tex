...
\midrule
\textbf{IMST-Mamba} & \textbf{0.332} & \textbf{44.7h}
...
vs.\ 49\%) at the same 90\% specificity (Table~\ref{tab:ewt}).  IMST-Mamba's
mean EWT of 44.7 hours provides clinically actionable lead time.  Wilcoxon
signed-rank test versus qSOFA$\geq$2 yielded $p=0.248$, reflecting wide
inter-patient variation in ICU time series; the practical gain is captured by
the 19.5-point improvement in detection rate.
