...
available at \url{https://github.com/[repository]}.
...
\midrule
\textbf{IMST-Mamba} & \textbf{0.7791} & \textbf{0.0514}
...
GRU-D            & 0.377 & 46.1h & 28.0h & 78.6\% & 70.6\% \\
LSTM             & 0.340 & 48.0h & 28.0h & 77.8\% & 66.3\% \\
Transformer      & 0.378 & 56.7h & 22.0h & 80.1\% & 69.0\% \\
\midrule
\textbf{IMST-Mamba} & 0.332 & 44.7h & 27.0h & 73.2\% & \textbf{68.5\%} \\
\bottomrule
\end{tabular}
\end{table}

All ML models detect substantially more sepsis patients than qSOFA (66--86\%
vs.\ 49\%) at the same 90\% specificity.  IMST-Mamba's mean EWT of 44.7 hours
provides clinically actionable lead time.
